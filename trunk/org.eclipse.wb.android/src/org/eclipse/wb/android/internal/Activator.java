...
public class Activator extends AbstractUIPlugin {
  public static final String PLUGIN_ID = "org.eclipse.wb.android";
  ...
  ////////////////////////////////////////////////////////////////////////////
  /**
   * Returns location of Android SDK from preferences.
   */
  public static String getAndroidSdkLocation() {
    return getDefault().getPreferenceStore().getString(IPreferenceConstants.P_ANDROID_SDK_LOCATION);
  }
  ...
  public static ToolkitDescription getToolkit() {
    return AndroidToolkitDescription.INSTANCE;
  }
}
